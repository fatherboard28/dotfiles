...
local function get_jdtls_paths()
  ...
  path.data_dir =  vim.fn.expand('$HOME/.local/share/nvim-jdtls')
  ...
  path.launcher_jar = vim.fn.glob(jdtls_install .. '/plugins/org.eclipse.equinox.launcher_1.6.900.v20240613-2009.jar')
  ...
  path.runtimes = {
    ...
    {
      name = 'JavaSE-17',
      path = vim.fn.expand('~/.sdkman/candidates/java/17.0.13-amzn'),
    },
    -- {
    --   name = 'JavaSE-18',
...
local function jdtls_setup(event)
  ...
  local lsp_settings = {
    java = {
      ...
      maven = {
        downloadSources = true,
        userSettings = os.getenv("HOME") .. "/.sdkman/candidates/maven/current/conf/settings.xml",
      },
